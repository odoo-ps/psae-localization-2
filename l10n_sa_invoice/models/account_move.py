...
class AccountMove(models.Model):
    ...
    l10n_sa_qr_code_str = fields.Char(string='QR Code', compute='_compute_qr_code_str')
    ...
    def _compute_qr_code_str(self):
        ...
        for record in self:
            ...
            if record.l10n_sa_confirmation_datetime and record.company_id.vat:
                ...
                timestamp_enc = get_qr_encoding(3, record.l10n_sa_confirmation_datetime.isoformat())
