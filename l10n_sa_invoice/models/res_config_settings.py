...
class ResConfigSettings(models.TransientModel):
    ...
    secondary_language = fields.Boolean(string="Enable Secondary Report Language", related="company_id.secondary_language", store=True,readonly=False)
    ...
    invoice_text = fields.Many2one(comodel_name="report.invoice.lang", related="company_id.invoice_text",store=True,readonly=False)